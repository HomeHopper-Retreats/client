  ...
  return (
    <div className="flex items-center px-4 py-3 rounded-md border-2 border-gray-700 overflow-hidden max-w-md mx-auto font-[sans-serif] mb-3">
      <form onSubmit={onSubmit} className="flex w-full">
        ...
        />
        {!submittedSearch ? (
          <button type="submit" name="searchButton" className="ml-2 focus:outline-none">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 192.904 192.904"
              width="16px"
              className="fill-gray-600 focus:outline-none"
            >
          ...
          >
            <svg
              className="w-4 h-4 text-gray-800 dark:text-gray-900 focus:outline-none"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
